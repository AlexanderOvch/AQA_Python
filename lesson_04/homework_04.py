...
print(f"\nTask 01-03 - {adwentures_of_tom_sawer}")

# task 04
""" Виведіть, скількі разів у тексті зустрічається літера "h"
"""
h_count = adwentures_of_tom_sawer.count('h')
print(f"\nTask 04 - Літера 'h' встречается в тексте {h_count} раз.")
...
print(f"\nTask 05 - Кількість слів, що починаються з великої літери: {len(capitalized_words)}")
...
print(f"\nTask 07 - Розділений текст на речення: {adwentures_of_tom_sawer_sentences}")

# task 08
""" Виведіть четверте речення з adwentures_of_tom_sawer_sentences.
Перетворіть рядок у нижній регістр.
"""
adwentures_of_tom_sawer_4 = adwentures_of_tom_sawer_sentences[3]

print(f"\nTask 08 - {adwentures_of_tom_sawer_4.lower()}")
...
print(f"\nTask 09 - {is_start_adwentures}:")  # True (если есть хотя бы одно предложение, иначе False)
...
print(f"\nTask 10 - Кількість слів останнього речення: {word_counnt}")